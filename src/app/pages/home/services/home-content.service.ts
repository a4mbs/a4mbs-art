...
import { iPageHomeContent } from '../../pages.interfaces';
...
export class HomepageContentService {
  ...
  constructor(private websiteConfigService: WebsiteConfigService) {
    this.pageContent = {
      sections: [
        ...
        //section 2
        {
          ...
          sectionContent: {
            ...
            text: {
              ...
              content: "I've been passionate about graphics for over 10 years, but what initially started as a hobby I decided to turn into a professional activity to which I dedicate full time. When your job is your passion, you can't say that you're working but rather living your dream and fulfilling your purpose, and work is a joy. I love graphics, I love to work, and I never get bored."
            },
            buttons: [
              {
                title: 'Take a look at my Adobe portfolio',
                link: this.websiteConfigService.getSocialMedia().find(item => item.title === 'Behance')?.link
              },
              {
                title: 'Read my blog',
                link: '/blog'
        ...
        //section 3
        {
          type: 'featureWithImageOnTheLeftAndBulletPoints',
          sectionContent: {
            hero: {
              image: {
            ...
            text: {
              ...
              content: "With the advent of generative art, the poetry of words came to life and took on color through the magic of some kind of image, which was hard to imagine or conceive before this revolutionary technology. Although I initially strongly rejected this new tool, I ended up loving it and using it almost nonstop. Creating a unique image using AI technology involves:",
            },
            listItems: [
              {
                icon: 'fi fi-rs-check-circle',
                content: "finding a theme, a subject, or simply falling into daydreaming"
              },
              {
                icon: 'fi fi-rs-check-circle',
                content: "developing the ability to express that vision in a prompt"
              },
              {
                icon: 'fi fi-rs-check-circle',
                content: "studying artistic movements and artworks, or even other generative artworks"
              },
              {
                icon: 'fi fi-rs-check-circle',
                content: "and last but not least, processing and finishing the generated image, giving it a personal touch and enriching what the machine has created"
              }
            ]
          }
        },
        ...
        //section 5
        {
          type: 'alternatedFeatureWithImagesAndText',
          sectionContent: [
            //element 1
            {
              hero: {
        ...
        //section 6
        {
          ...
          sectionContent: {
            text: {
              ...
              content: "I choose to create what represents me, and I find it very hard not to find myself in my artwork.",
            },       
            features: [
              //element 1
              {
                ...
                text: {
                  ...
                  content: "Despite a tumultuous past, my fondness for childhood's magic, reflected in my choice of having five children, greatly influences and enhances the themes of my artistic work."
                }
              },
              //element2
              {
                ...
                text: {
                  ...
                  content: "I believe that as artists, we have the unique privilege of looking beyond what is scientifically visible or measurable, allowing us to delve into life's mysteries and potentially uncover its true meaning."
                }
              },
              //element 3
              {
                ...
                text: {
                  title: 'Surrealism',
                  content: "David Lynch and later Salvador Dali represented my first magical encounters with art. I had seen other artists in my childhood, but these two left the most profound imprint on my beginnings."
                }
              },
              //element 4
              {
                ...
                text: {
                  ...
                  content: "Although initially works like Picasso's paintings, cubism, expressionism, dadaism, and even modern abstract art seemed strange, a scribble, in recent years I have become increasingly fascinated by these movements."
                }
              }
            ]
          }
  ...
  getImagesForComponent(): iDisplayImage{
    return this.pageContent.sections[2].sectionContent.hero;
  }
